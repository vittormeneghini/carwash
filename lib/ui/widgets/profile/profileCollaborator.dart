...
class ProfileCollaborator extends StatefulWidget {
  Person person;
  ProfileCollaborator(this.person);

  @override
  _ProfileCollaboratorState createState() => _ProfileCollaboratorState(person);
}

class _ProfileCollaboratorState extends State<ProfileCollaborator> {
  Person person;
  ...
  _ProfileCollaboratorState(this.person) {
    getAddress();
    ...
    _controllerCpf = TextEditingController(text: person.cpf);
  ...
  Future<void> updatePerson() async {
    setState(() {
      ...
      person.cpf = _controllerCpf.text;
      isLoading = true;
    });
